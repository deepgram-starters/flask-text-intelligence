# flask-text-intelligence

Flask demo app for Deepgram Text Intelligence.
...
```
feat(flask-text-intelligence): add diarization support
fix(flask-text-intelligence): resolve WebSocket close handling
refactor(flask-text-intelligence): simplify session endpoint
